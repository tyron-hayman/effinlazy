...
$block .= '<div class="ef3_about_block">';
        $block .= '<div class="ef3_about_block_content">';
            ...
            $block .= '<div class="ef3_about_block_image"><div class="ef3_about_block_image_bg" style="background: url(' . $ef3_about_block_content["image"] . ') center center no-repeat;"></div><div class="ef3_about_block_image_box"></div></div>';
